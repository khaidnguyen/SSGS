...
def script_examples():
    ...
    print("\n- sys-info-redfish.py -ip 172.31.3.232 -u ADMIN -p $upermicro -m y, this example will get only memory information\n- sys-info-redfish.py -ip 172.31.3232 -u ADMIN -p $upermicro -c y -m y, this example will get only processor and memory information\n- GetSystemHWInventoryREDFISH.py -ip 172.31.3.232 -u ADMIN -p $upermicro -a y, this example will get all system information(general system information, processor, memory, fans, power supplies, hard drives, storage controllers, network devices)")
